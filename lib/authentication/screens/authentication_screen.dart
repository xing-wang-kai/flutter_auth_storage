...
class _AuthScreenState extends State<AuthScreen> {
  ...
  _entrarUsuario({required String email, required String senha}) {
    authService.userLoggin(email: email, password: senha).then((String? erro) {
      if (erro == null) {
        showSnackBar(
          context: context,
          message: "Usuáro logado com sucesso!",
          isError: false,
        );
      } else {
  ...
  _criarUsuario({
    ...
    authService
        .userCreateAccount(email: email, password: senha, name: nome)
        .then((String? erro) {
          if (erro == null) {
            showSnackBar(
            ...
            showSnackBar(message: erro, context: context);
          }
        });
  }
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              onPressed: () {
                authService.redifinerPasswor(
                    email: redefincaoSenhaController.text
                ).then((String? erro){
                  if(erro != null){
                    showSnackBar(context: context, message: erro);
                  }
                    ...
                    showSnackBar(
                        context: context,
                        message: "Email para redefinir senha enviado para $email",
                        isError: false);
                  }
